...
public class LocalAuthController {
    ...
    @ResponseBody
    private Map<String, Object> createAuth(HttpServletRequest request) {
        ...
        // personal info
        String name= HttpServletRequestUtil.getString(request, "uname");;
        ...
        if (userName != null && password != null) {
            ...
            modelMap.put("success", false);
            modelMap.put("errMsg", "input part can't be empty");
        }
        return modelMap;
    }
